...
class ComparisonUtilityTest {
    ...
    void numericTolerance() {
        assertThat(comparisonUtility.matches("220.50", "220.50", MatchType.NUMERIC_TOLERANCE, BigDecimal.ZERO)).isTrue();
        assertThat(comparisonUtility.matches("220.50", "220.51", MatchType.NUMERIC_TOLERANCE, BigDecimal.ZERO)).isFalse();
